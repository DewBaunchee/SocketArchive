package by.varyvoda.matvey.server.app.dao;


import by.varyvoda.matvey.server.app.dao.iface.IDao;
import by.varyvoda.matvey.server.app.dao.query.Query;
import by.varyvoda.matvey.server.app.dao.session.Session;
import by.varyvoda.matvey.server.app.dao.session.exception.SessionCommittedException;
